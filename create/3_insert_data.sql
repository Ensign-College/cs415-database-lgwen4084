...
VALUES
  (1, 1, '8015551000', CURRENT_TIMESTAMP, true, 1),
  (2, 2, '8015551001', CURRENT_TIMESTAMP, true, 1),
  (3, 1, '8015552000', CURRENT_TIMESTAMP, true, 2),
  (4, 3, '8015552001', CURRENT_TIMESTAMP, true, 2);
...
VALUES
  (1, 1, 'Main user profile for testing the website.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTYZ4AiSTOD6IbZ-zuTTghcjbMr15XMj1XSQ&s', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 2, 'Willie Nelson test profile for the website.', 'https://is1-ssl.mzstatic.com/image/thumb/Features125/v4/b4/c2/9a/b4c29a1e-3b45-2b60-be65-dbb96d21e42a/mza_1383128222591135178.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
